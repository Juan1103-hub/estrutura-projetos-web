---
name: deploy-checker
description: Validar projeto contra checklist de go-live do DEPLOY.md. Verifica Supabase (RLS, policies, security advisor), Vercel (env vars, headers, HTTPS), domínio e verificação final. Não edita arquivos.
---
